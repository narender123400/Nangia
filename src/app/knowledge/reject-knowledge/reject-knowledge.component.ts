...
@Component({
  selector: 'app-reject-knowledge',
  templateUrl: './reject-knowledge.component.html'
})
export class RejectKnowledgeComponent implements OnInit {
...
pageSize:any=50;  
  ...
  getallknowlist(pagelimit:any=20,start:any=0,action:any=''){
    ...
    this.db.FetchData({'search':this.search,'start':this.start,'pagelimit':this.pagelimit},'Knowledge/get_all_Reject_knowledge_base')
      .subscribe( r=>{
      console.log(r);
